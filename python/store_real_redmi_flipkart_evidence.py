...
if base_offer is None:
    raise RuntimeError("Flipkart identity not found for Redmi")
...
evidence = PriceEvidence(
    ...
    confidence=0.97,
    notes=(
        "Exact Redmi 13 5G Hawaiian Blue 8GB/128GB "
        "Flipkart listing verified. Current page shows "
        "seller and delivery by 31 Aug 2026. "
...
print()
print("REAL REDMI FLIPKART EVIDENCE STORED")
